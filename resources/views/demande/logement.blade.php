...
h1
{
 ...
 <div class="onglets_html">
        <div class="onglets">
            ...
            <div class="onglet_n onglet"><a href="{{ url('destinations') }}">Pays</a></div>
            <div class="onglet_y onglet"><a href="{{ url('logements') }}">Type de logement</a></div>
  ...
  <div class="container">    
     ...
     <br />
     <div align="right">
      <button type="button" name="create_record" id="create_record" class="btn btn-success btn-sm">un autre type de logement</button>
     </div>
     <br />
